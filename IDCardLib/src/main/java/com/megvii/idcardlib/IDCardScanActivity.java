...
public class IDCardScanActivity extends Activity implements TextureView.SurfaceTextureListener, Camera.PreviewCallback {
    ...
    private float mInBound, mIsIDCard,mClear;
    ...
    private void initData() {
        ...
        if (!initSuccess) {
            ...
            idCardQualityAssessment.mClear=0.7f;
            mClear=idCardQualityAssessment.mClear;
        }
    }
                ...
                while ((imgData = mFrameDataQueue.take()) != null) {
                    ...
                    if (result != null) {
                        if (result.attr != null) {
                            ...
                            float lowQuality=result.attr.lowQuality;
                            Log.e("ceshi", "run: isIDCard ==" + isIDCard + ", " + mIsIDCard + ", " + inBound + ", " + mInBound+"======="+result.attr.lowQuality+"==========="+mClear);
                            if (isIDCard > mIsIDCard && inBound > 0 && lowQuality > mClear)
                                if (!mIsVertical)
