...
package com.hdfex.sdk.pullrefreshlayout;
 ...
 * 描述:类似新浪微博下拉刷新风格
 */
public class BGANormalComRefreshViewHolder extends BGARefreshViewHolder {
    ...
    private  boolean isHidLoadingText=false;
     ...
     */
    public BGANormalComRefreshViewHolder(Context context, boolean isLoadingMoreEnabled) {
        super(context, isLoadingMoreEnabled);
        initAnimation();
    }

    public void setHidLoadingText(boolean hidLoadingText) {
        isHidLoadingText = hidLoadingText;
    }
    ...
    public View getRefreshHeaderView() {
        if (mRefreshHeaderView == null) {
            mRefreshHeaderView = View.inflate(mContext, R.layout.view_refresh_header_normal_com, null);
