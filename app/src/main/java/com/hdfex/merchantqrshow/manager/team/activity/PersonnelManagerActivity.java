...
public class PersonnelManagerActivity extends BaseActivity implements View.OnClickListener, PersonnelManagerContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        presenter = new PersonnelManagerPresenter();
    ...
    public static void startAction(Context context) {
        Intent intent = new Intent(context, PersonnelManagerActivity.class);
