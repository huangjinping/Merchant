...
public class UploadPhotoActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void upLoadURL(final File file) {
        ...
        OkHttpUtils.post()
            ...
            public void onError(Call call, Exception e) {
                ToastUtils.makeText(UploadPhotoActivity.this, e.getMessage()).show();
            }
            ...
            public void onResponse(String response) {
                ...
                if (bussinessNameRepponse.getCode() == 0 && bussinessNameRepponse.getResult() != null) {
                    ...
                    updateView(file, result.getRelativePath(), result.getAbsolutePath());
                    /**
                     * 去哪里
                     */
                } else {
                    ToastUtils.e(UploadPhotoActivity.this, bussinessNameRepponse.getMessage() + "").show();
                }
            }
        });
     ...
     * @param imageFile
     */
    private void updateView(File imageFile, String relativePath, String absolutePath) {
    ...
    private void setOnLiteners() {
        ...
        grv_lease_contract.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (!sdcardExist()) {
                    ToastUtils.makeText(UploadPhotoActivity.this, "未检测到SD卡").show();
                    return;
                }
                ...
                if (TextUtils.isEmpty(currentImageModel.getPath()) && currentImageModel.getImageFile() == null) {
                    ...
                    EasyImage.openChooser(UploadPhotoActivity.this, "选择图片来源");
...
//                            .count(9)
//                            .spanCount(4)
//                            .start(UploadPhotoActivity.this, Constant.REQUEST_IMAGE_FORM);

                    return;
                }
                Intent intent = new Intent(UploadPhotoActivity.this, PhotoViewActivity.class);
...
//                    getPic();
    ...
    private void processEasyImage(int requestCode, int resultCode, Intent data) {
        ...
        EasyImage.handleActivityResult(requestCode, resultCode, data, UploadPhotoActivity.this, new DefaultCallback() {
            @Override
            public void onImagePickerError(Exception e, EasyImage.ImageSource source) {

                Log.d("hjp", e.toString());
                ToastUtils.i(UploadPhotoActivity.this, "拍照过程中遇到问题" + e.toString(), Toast.LENGTH_LONG).show();
            }
            ...
            public void onImagePicked(File imageFile, EasyImage.ImageSource source) {
                ...
                FileImageUtils.saveCatchBitmap(StringUtils.md5(mFileTemp.getName()), zoombitmapBitmap, UploadPhotoActivity.this, catchpath);
...
//                startCropImage(imageFile);
                LogUtil.d(UploadPhotoActivity.class.getSimpleName(), imageFile.toString());
            }

            @Override
            public void onCanceled(EasyImage.ImageSource source) {
                ToastUtils.i(UploadPhotoActivity.this, "拍照过程中遇到问题onCanceled", Toast.LENGTH_LONG).show();
                //Cancel handling, you might wanna remove taken photo if it was canceled
                if (source == EasyImage.ImageSource.CAMERA) {
                    File photoFile = EasyImage.lastlyTakenButCanceledPhoto(UploadPhotoActivity.this);
