...
import com.hdfex.merchantqrshow.salesman.order.fragment.OrderSearchMonthlyListFragment;
 ...
 * 订单列表
 */
public class OrderMonthlyListActivity extends BaseActivity implements View.OnClickListener {

    private ImageView img_back;
    private EditText edt_order_search;
    private TextView txt_search;
    private FragmentTransaction fragmentTransaction;
    private OrderSearchMonthlyListFragment fragment;
    ...
    private void setLiteners() {
        ...
        edt_order_search.setHint("请输入房屋地址，小区名称");
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, OrderMonthlyListActivity.class);
    ...
    private void submit() {
        ...
        if (fragment == null) {
            fragment = OrderSearchMonthlyListFragment.getInstance("0", search);
