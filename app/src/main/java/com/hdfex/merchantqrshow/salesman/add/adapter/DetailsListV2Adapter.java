 ...
 */
public class DetailsListV2Adapter extends BaseAdapter {
    private List DetailsList;
    private Context context;
    private MyListViewClickListener clickListener;

    public DetailsListV2Adapter(Context context, List DetailsList, MyListViewClickListener clickListener) {
