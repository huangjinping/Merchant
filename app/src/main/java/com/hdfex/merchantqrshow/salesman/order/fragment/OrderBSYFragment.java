...
public class OrderBSYFragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fragmentList.add(OrderListBSYFragment.getInstance("0"));
        fragmentList.add(OrderListBSYFragment.getInstance("1"));
        fragmentList.add(OrderListBSYFragment.getInstance("2"));
