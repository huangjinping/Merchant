 ...
 */
public class WofuListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public WofuListAdapter(List<LedingOrder> dataList, String type) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (position > 0) {
            ...
            LedingOrder item = dataList.get(index);
            ...
            viewholder.txt_change_fund.setText("审核通过");
            ...
            viewholder.txt_refuse_apply.setText("审核拒绝");
