...
public class OrderHuabeiFragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_bsyorder, container, false);
        initView(view);
        fragmentList = new ArrayList<>();
        fragmentList.add(OrderListHuabeiFragment.getInstance("0"));
        fragmentList.add(OrderListHuabeiFragment.getInstance("2"));
        fragmentList.add(OrderListHuabeiFragment.getInstance("3"));
