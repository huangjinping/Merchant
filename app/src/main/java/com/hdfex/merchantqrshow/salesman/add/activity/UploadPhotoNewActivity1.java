...
public class UploadPhotoNewActivity1 extends BaseActivity implements View.OnClickListener {
    ...
    private void upLoadURL(final File file, final int postion, final int imagetype) {
        ...
        if (!FileImageUtils.isFileChack(file)) {
            ToastUtils.makeText(UploadPhotoNewActivity1.this, "图片格式或大小异常,请重新选择").show();
            return;
        }
        ...
        OkHttpUtils.post()
            ...
            public void onError(Call call, Exception e) {
                dismissProgress();
                ToastUtils.makeText(UploadPhotoNewActivity1.this, e.getMessage()).show();
            }
...
//                        if (imagetype==Constant.REQUEST_IMAGE_FORM){
                        if (postion < (mSelectPath.size() - 1)) {
                            File file = FileImageUtils.getFile(mSelectPath.get(postion + 1));
                            upLoadURL(file, postion + 1, Constant.REQUEST_IMAGE_FORM);
                            return;
                        }
                        dismissProgress();
                        /**
                        ...
                        dismissProgress();
                        ToastUtils.e(UploadPhotoNewActivity1.this, bussinessNameRepponse.getMessage() + "").show();
                    }
                } catch (Exception e) {
                    dismissProgress();
                    e.printStackTrace();
    ...
    private void setOnLiteners() {
        ...
        grv_lease_contract.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (!sdcardExist()) {
                    ToastUtils.makeText(UploadPhotoNewActivity1.this, "未检测到SD卡").show();
                    return;
                }
...
//                    EasyImage.openChooser(UploadPhotoNewActivity.this, "选择图片来源");
                    ...
                    selector.origin(null)
                            ...
                            .count(9)
                            .spanCount(4)
                            .start(UploadPhotoNewActivity1.this, Constant.REQUEST_IMAGE_FORM);

                    return;
                }
                Intent intent = new Intent(UploadPhotoNewActivity1.this, PhotoViewActivity.class);
...
//                    EasyImage.openChooser(UploadPhotoNewActivity.this, "选择图片来源");
                    ...
                    selector.origin(null)
                            ...
                            .count(9)
                            .spanCount(4)
                            .start(UploadPhotoNewActivity1.this, Constant.REQUEST_IMAGE_TOM);
                    return;
                }
...
//                upLoadURL(FileImageUtils.getFile(mSelectPath.get(0)), 0, Constant.REQUEST_IMAGE_FORM);
                ...
                progressParseFile(mSelectPath.toArray(new  String[mSelectPath.size()]));
...
//        }
     ...
     * 转换path 到file
     */
    private void progressParseFile(String[] filePath) {

        Observable.from(filePath).map(new Func1<String, File>() {
            @Override
            public File call(String s) {
                File file = FileImageUtils.getFile(s);
                if (FileImageUtils.isFileChack(file)){
                     file = FileImageUtils.compressByFile(file, UploadPhotoNewActivity1.this);
                }
                return file;
            }
                ...
                .subscribe(new Subscriber<File>() {
                    ...
                    public void onNext(File file) {
                        updateView(file, null, null, true, null);
                    }
                });
    }
    ...
    private void processEasyImage(int requestCode, int resultCode, Intent data) {
        ...
        EasyImage.handleActivityResult(requestCode, resultCode, data, UploadPhotoNewActivity1.this, new DefaultCallback() {
            @Override
            public void onImagePickerError(Exception e, EasyImage.ImageSource source) {

                Log.d("hjp", e.toString());
                ToastUtils.i(UploadPhotoNewActivity1.this, "拍照过程中遇到问题" + e.toString(), Toast.LENGTH_LONG).show();
            }
            ...
            public void onImagePicked(File imageFile, EasyImage.ImageSource source) {
                ...
                FileImageUtils.saveCatchBitmap(StringUtils.md5(mFileTemp.getName()), zoombitmapBitmap, UploadPhotoNewActivity1.this, catchpath);
                File bitmap = FileImageUtils.getFile(catchpath + "/" + StringUtils.md5(mFileTemp.getName()));
                onPhotoReturned(bitmap);
                LogUtil.d(UploadPhotoNewActivity1.class.getSimpleName(), imageFile.toString());
            }

            @Override
            public void onCanceled(EasyImage.ImageSource source) {
                ToastUtils.i(UploadPhotoNewActivity1.this, "拍照过程中遇到问题onCanceled", Toast.LENGTH_LONG).show();
                //Cancel handling, you might wanna remove taken photo if it was canceled
                if (source == EasyImage.ImageSource.CAMERA) {
                    File photoFile = EasyImage.lastlyTakenButCanceledPhoto(UploadPhotoNewActivity1.this);
