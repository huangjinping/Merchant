...
public class OrderFragment2 extends BaseFragment implements View.OnClickListener, OrderListContract.View {
...
//                    img_tab_icon2.setImageResource(R.mipmap.ic_arrow_up);
    ...
    private void currentFragment(int  tab,String type) {
         ...
         * 设置
         */
        showToast(tab+"currentFragment"+type);
...
//        fragmentTransaction.commit();
    ...
    private void initViewpagerData() {
        ...
        adapter =new OrderPagerAdapter(getFragmentManager());
        vip_order.setAdapter(adapter);
