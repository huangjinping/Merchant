...
import com.hdfex.merchantqrshow.salesman.add.fragment.ResourcesSearchPayFragment;
...
public class SelectPayResourceActivity extends BaseActivity implements View.OnClickListener {
    ...
    private ResourcesPayFragment fragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragment = ResourcesPayFragment.getInstance("1", true, true);
        ...
        register.subscribe(new Subscriber<Object>() {
            ...
            public void onNext(Object o) {
                SelectPayResourceActivity.this.finish();
            }
        });
        updateView();
        ...
        registerOpenSearch.subscribe(new Subscriber<Object>() {
            ...
            @Override
            public void onNext(Object o) {
                ResourcesSearchPayFragment fragment = ResourcesSearchPayFragment.getInstance();
    ...
    private void initView() {
        ...
        iv_eite.setVisibility(View.GONE);
        iv_eite.setTag(EDIT);
    }
    ...
    private void setCurrentHouseType() {
        ...
        if (houseTypeMap != null) {
            if (houseTypeMap.containsKey(IntentFlag.HOUSE_TYPE_CONCENTRATE) && houseTypeMap.containsKey(IntentFlag.HOUSE_TYPE_DISPERSE)) {
                ...
                AddHouseActivity.start(SelectPayResourceActivity.this, IntentFlag.HOUSE_TYPE_CONCENTRATE);
                return;
            } else if (houseTypeMap.containsKey(IntentFlag.HOUSE_TYPE_DISPERSE)) {
                AddHouseActivity.start(SelectPayResourceActivity.this, IntentFlag.HOUSE_TYPE_DISPERSE);
                return;
            }
        }
