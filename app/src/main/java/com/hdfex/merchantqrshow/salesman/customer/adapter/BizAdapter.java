...
public class BizAdapter extends BaseExpandableListAdapter {
    ...
    public BizAdapter(Context context, List<RegionResult> dataList) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_biz_child, null);
        ...
        viewHolder.rootView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                EventRxBus.getInstance().post(IntentFlag.TURN_ORDER, person);
            }
        });
...
//            viewHolder.img_status.setImageResource(R.mipmap.ic_check_light);
//        } else {
//            viewHolder.img_status.setImageResource(R.mipmap.ic_check_gray);
//        }
