...
public class PeriodsAdapter extends BaseAdapter {
    ...
    public PeriodsAdapter(List<TypeModel> dataList, Context context) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(typeModel.getName()) && viewHolder.img_period_counter != null) {
                viewHolder.img_period_counter.setText(typeModel.getName() + "期");
            }
            if (!TextUtils.isEmpty(typeModel.getCapitalName()) && viewHolder.img_period_name != null) {
                viewHolder.img_period_name.setText(typeModel.getCapitalName());
            }
