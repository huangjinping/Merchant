    ...
    public void setSelectedItem(String province, String city, String county) {
        for (int i = 0; i < provinceList.size(); i++) {
            ...
            if (pro.contains(province)) {
                ...
                LogUtil.d("init select province: " + pro);
                break;
            }
        }
        ...
        for (int j = 0; j < cities.size(); j++) {
            ...
            if (cit.contains(city)) {
                selectedCityIndex = j;
                LogUtil.d("init select city: " + cit);
                break;
            }
        }
        ...
        for (int k = 0; k < counties.size(); k++) {
            ...
            if (cou.contains(county)) {
                ...
                LogUtil.d(AddressPicker.class.getSimpleName(), "init select county: " + cou);
                break;
            }
        }
        LogUtil.d(AddressPicker.class.getSimpleName(), String.format("init select index: %s-%s-%s", selectedProvinceIndex, selectedCityIndex, selectedCountyIndex));
    }
