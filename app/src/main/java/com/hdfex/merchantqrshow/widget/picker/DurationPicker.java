 ...
 */
public class DurationPicker extends  WheelPicker {
    ...
    public DurationPicker(Activity activity, List<String> item) {
        super(activity);
      this.item=item;

    }

    public DurationPicker(Activity activity, List<String> item, OnDurationPickerSelectedListener onDurationPickerSelectedListener) {
        super(activity);
        this.item = item;
        this.onDurationPickerSelectedListener = onDurationPickerSelectedListener;
    }
    ...
    protected View makeCenterView() {
        ...
        provinceView.setOnWheelViewListener(new WheelView.OnWheelViewListener() {
            ...
            public void onSelected(boolean isUserScroll, int selectedIndex, String item) {
                DurationPicker.this.selectedIndex=selectedIndex;
                selectedItem=item;
